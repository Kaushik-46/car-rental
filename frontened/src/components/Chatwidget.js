...
const Chatwidget = () => {
  ...
  useEffect(() => {
    addResponseMessage(
      `Welcome ${user.username}, I'm Blacky 🤖🖐️ a bot. How can i help you today?`
    );
  }, []);
  const handleNewUserMessage = (newMessage) => {
    ...
    if (
      ...
      addResponseMessage(
        `Our address is kongu engineering college.`
      );
    } else if (
      ...
      addResponseMessage(`I'm Blacky & I'm a Bot 🤖`);
    } else {
      addResponseMessage(
