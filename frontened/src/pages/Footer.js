      ...
      <footer className="footer-section ">
        <div className="container">
          <div className="footer-cta pt-5 pb-5">
            <div className="row2">
              <div className="new1 col-xl-3 col-md-3 mb-30">
              ...
              <div className="new2 col-xl-4 col-md-4 mb-30">
                <PhoneOutlined className="f-icons" />
                <div className="single-cta">
                  <div className="cta-text">
                    <h4>Call us</h4>
                    <span>+917894561236</span>
                  </div>
                </div>
              </div>
              <div className=" new3 col-xl-4 col-md-4 mb-30">
                <MailOutlined className="f-icons" />
                <div className="single-cta">
                  <div className="cta-text">
                    <h4>Mail us</h4>
                    <span>aparna12345abi@gmail.com</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="copyright-area">
          <div className="container">
            <div className="row">
              ...
              <div className="col-xl-6 col-lg-5 d-none d-lg-block text-right">
